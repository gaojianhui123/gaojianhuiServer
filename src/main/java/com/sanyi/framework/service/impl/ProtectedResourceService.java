...
import com.sanyi.framework.dao.ProtectedResourceRepository;
import com.sanyi.framework.model.ProtectedResource;
import com.sanyi.framework.model.QProtectedResource;
...
public class ProtectedResourceService extends BaseService<ProtectedResource> {
	...
	/*
	 * (non-Javadoc)
	 * @see com.sanyi.framework.service.impl.BaseService#packagePredicate(com.sanyi.framework.page.QueryParam)
	 * 查询条件
	 */
